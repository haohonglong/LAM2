(function(global, factory) {
     ...
     * 名称： Canvas
     * 功能：Canvas 绘图封装类
     * 说明：提供对 HTML5 Canvas 的封装，支持2D绘图操作
     * 注意：
    ...
    var Canvas = Browser.extend({
         ...
         * 说明：
         * 注意：
         * @param 	(Number)width         NO NULL : 画布宽度
         * @param 	(Number)height        NO NULL : 画布高度
         * @returns {Canvas}
         * Example：
         ...
         * 说明：
         * 注意：
         * @param 	(Number)x         NO NULL : 圆心x坐标
         * @param 	(Number)y         NO NULL : 圆心y坐标
         * @param 	(Number)radius    NO NULL : 圆半径
         ...
         */
        'circle': function(x, y, radius, fillStyle, strokeStyle) {
            this.beginPath();
         ...
         * 说明：
         * 注意：
         * @param 	(Number)x         NO NULL : 矩形左上角x坐标
         * @param 	(Number)y         NO NULL : 矩形左上角y坐标
         * @param 	(Number)width     NO NULL : 矩形宽度
         * @param 	(Number)height    NO NULL : 矩形高度
         * @param 	(String)fillStyle    NULL : 填充颜色
         * @param 	(String)strokeStyle  NULL : 描边颜色
         * @returns {Canvas}
         * Example：
         ...
         */
        'rect': function(x, y, width, height, fillStyle, strokeStyle) {
            this.beginPath();
         ...
         * 创建日期：2025.11.2
         * 修改日期：2025.11.2
         * 名称： createLinearGradient
         * 功能：创建线性渐变
         * 说明：
         * 注意：
         * @param 	(Number)x0        NO NULL : 渐变开始点x坐标
         * @param 	(Number)y0        NO NULL : 渐变开始点y坐标
         * @param 	(Number)x1        NO NULL : 渐变结束点x坐标
         * @param 	(Number)y1        NO NULL : 渐变结束点y坐标
         * @param 	(Array)stops      NO NULL : 渐变颜色停止点数组
         * @returns {CanvasGradient}
         * Example：

         */
        'createLinearGradient': function(x0, y0, x1, y1, stops) {
         ...
         * 说明：
         * 注意：
         * @param 	(Function)callback NO NULL : 动画回调函数
         * @returns {Canvas}
         * Example：
         ...
         * 说明：
         * 注意：
         * @param 	(Number)offsetX   NO NULL : 阴影水平偏移
         * @param 	(Number)offsetY   NO NULL : 阴影垂直偏移
         * @param 	(Number)blur      NO NULL : 阴影模糊程度
         * @param 	(String)color     NO NULL : 阴影颜色
         * @returns {Canvas}
         * Example：
         ...
         * 说明：
         * 注意：
         * @param 	(String)text      NO NULL : 要测量的文本
         * @param 	(String)font        NULL : 字体样式
         * @returns {TextMetrics}
         * Example：
         ...
         * 说明：
         * 注意：
         * @param 	(String)key       NO NULL : 缓存键名
         * @param 	(Number)width       NULL : 缓存画布宽度
         * @param 	(Number)height      NULL : 缓存画布高度
         * @returns {CanvasRenderingContext2D}
         * Example：

         */
        'createCache': function(key, width, height) {
            var offscreen = document.createElement('canvas');
            offscreen.width = width || this.getWidth();
            offscreen.height = height || this.getHeight();
         ...
         * 说明：
         * 注意：
         * @param 	(String)event     NO NULL : 事件类型
         * @param 	(Function)handler NO NULL : 事件处理函数
         * @returns {Canvas}
         * Example：

         */
        'on': function(event, handler) {
            this.theCanvas.addEventListener(event, handler);
            return this;
        },
        ...
        'off': function(event, handler) {
            this.theCanvas.removeEventListener(event, handler);
            return this;
        },
